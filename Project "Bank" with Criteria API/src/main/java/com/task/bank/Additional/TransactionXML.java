...
public class TransactionXML {
    ...
    public void createXML(List<Transaction> transactionList, String fileName, String path) throws TransformerException {
        ...
        StreamResult result = new StreamResult(new File(path + "TransactionsFiles/" + fileName + "Transactions.xml"));
